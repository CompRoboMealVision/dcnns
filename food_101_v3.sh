...
--output_graph=$HOME/data/models/food_101_v3/retrained_graph.pb \
--output_labels=$HOME/data/models/food_101_v3/retrained_labels.txt \
--summaries_dir=$HOME/data/models/food_101_v3/retrain_logs \
